...
function Invoke-All {
    ...
    '09-databases.ps1', '10-accessibility.ps1' | ForEach-Object { Invoke-Script $_ }
}
...
while ($running) {
    ...
    switch ($choice) {
        ...
        default { Write-AccessibleMessage "Opcao invalida: '$choice'. Digite um numero de 0 a 11." 'AVISO' }
    }
    if ($running) {
        Write-Host ''
